...
RUN wget -q https://github.com/hankcs/HanLP/releases/download/v${hanlp_data_version}/data-for-${hanlp_data_version}.zip -O full-hanlp-data.zip
RUN unzip -uq full-hanlp-data.zip -d plugins/analysis-hanlp \
